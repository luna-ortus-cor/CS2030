...
interface ImList<E> extends Iterable<E> {
    ...
    static <E> ImList<E> of(List<? extends E> list) {
        return new ImList<E>() {
            ...
            //change all newList.elems to e.g.
            //List<E> new List = new ArrayList<E>(this.elems);
            //newList.add(elem);
            //return ImList.of(newList);
            //i.e. do not use new constructor ImList
    ...
    //Optional<E> reduce(BiFunction<? super E, ? super E, ? extends E> acc) {
    Optional<E> reduce(Function<? super E, Function<? super E, ? extends E>> acc) {
        return this.size() == 0 ? Optional.empty() :
            Optional.of(elems.get(0))
                .map(x -> this.remove(0)
                        .reduce(x, (a, b) -> acc.apply(a).apply(b)));
    }
    ...
    public boolean isEmpty();
    public Iterator<E> iterator();
    public <E> U reduce(U identity, BiFunction<? super U, ? super E, ? extends U> acc);
