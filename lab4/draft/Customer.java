...
public class Customer implements Comparable<Customer> {
    ...
    /**
     * alternate constructor for customer using customer.
     * @param c other customer
     */
    public Customer(Customer c, double serveTime, double endTime, int state) {
     ...
     * get supplier.
     */
    public double getSupplierServeTime() {
        return this.sup.get();
    }
